    ...
    <div class="wrap">
   	...
   	<script>
            ...
            <div class="sub_tab">
                <div class="sub_tab_co">
                    <div class="sub_tab_in">
                        <a href="cp_01.jsp" class="active">회사소개</a><!--
        ...
        <div class="body_Wrap">
            ...
            <div class="top_view">
                <h5>누구나 원하는 따뜻한 사람,</h5>
                <h3 class="co_name">D A O N</h3>
                <p>
                    다온을 통해서 <b>새로운 인연</b>을 만나보세요!<br>
                    <b>나의 이상형</b>이 반영된 인연이 당신께 찾아갑니다!
                </p>
            </div>   
        </div>
        <div class="top_view2">
            <div class="container">
                ...
                <dl>
                    <dd class="wow fadeIn" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;">
                        <img src="../icon/jh/bridge.png" class="icon01">
                        <p>
                            다온은 고객님의 취향 / 이상형 / 가치관을 가진<br>
                            이성과의 만남을 주선하기 위해 만든 국내 최초<br>
                            <b>프리미엄 "연애" 소개팅 서비스</b>입니다.
                        </p>
                    </dd>
                    <dd class="wow fadeIn" data-wow-duration="2s" data-wow-delay="1s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;">
                        <img src="../icon/jh/Lovecomplete.png" class="icon01">
                        <p>
                            설렘 가득한 새로운 만남이 필요하시다구요?<br>
                            연인을 만나고 싶다면 다온의 문을 두드려주세요!<br>
                            다온에서<b>당신의 사랑을 완성</b>시켜드리겠습니다!
                        </p>
                    </dd>
                </dl>
                <div class="info_btn">
                    <p>다온의 세부규정과 환불규정을 알아봅시다!</p>
                    <a href="../Company introduction/cp_09.jsp">
                        <img src="../icon/app_apple.png">
                    </a>
                    <a href="../Company introduction/cp_10.jsp">
                        <img src="../icon/app_andro.png">
                    </a>
                    <p class="ment">
                        <b class="met">“ To love someone is to identify with them</b>  -  누군가를 사랑한다는 것은 자신을 그와 동일 시 하는 것이다. ”
                    </p>
                </div>
            </div>
        </div>
        <div class="view3">
            <div class="container_w">
                ...
                <img src="../icon/sap01.png" class="img02">
                <h5 class="right">
                    <b>
                        국내 최초로 타 회사보다는 부담이 적고 <br>
                        캐쥬얼 데이팅보다는 진지하게
                    </b><br>
                    다온의 따뜻한 응원과 환호 속에서 당신의<br>
                    사랑을 완성시켜드리겠습니다!<br>
                    믿음직한 연결다리!&nbsp;&nbsp;D&nbsp;&nbsp;A&nbsp;&nbsp;O&nbsp;&nbsp;N&nbsp;&nbsp;!
                </h5>
                <p class="ment2">
                    <b class="met">“ Love is, above all else, the gift of oneself</b>  - 사랑은 무엇보다도 자신을 위한 선물이다. ”
                </p>
            </div>
        </div>
        <div class="set3">
            <div class="conwrap">
                <div class="title001">다온의 핵심가치</div>
                <div class="title002">고객을 위한 다온</div>
                <ul>
                    <li class="mr8">
                        <div class="num">♡</div>
                        <div class="ico"><img src="../icon/jh/Practice.png" class="ico-1"></div>
                        <dl>
                            <dt>실행력</dt>
                            <dd>Practice</dd>
                        </dl>
                    ...
                    <li class="mr8">
                        <div class="num">♡</div>
                        <div class="ico"><img src="../icon/jh/Affinity.png" class="ico-1"></div>
                        <dl>
                            <dt>소통과 협력</dt>
                            <dd>Affinity</dd>
                        </dl>
                    ...
                    <li class="mr8">
                        <div class="num">♥</div>
                        <div class="ico"><img src="../icon/jh/Customer.png" class="ico-1"></div>
                        <dl>
                            <dt>고객 우선</dt>
                            <dd>Customer centricity</dd>
                        </dl>
                    </li>
                    <li class="mr8">
                        <div class="num">♡</div>
                        <div class="ico"><img src="../icon/jh/Integrity.png" class="ico-1"></div>
                        <dl>
                            <dt>신뢰</dt>   
                            <dd>Integrity</dd>
                        </dl>
                    ...
                    <li>
                        <div class="num">♡</div>
                        <div class="ico"><img src="../icon/jh/Responsibility.png" class="ico-1"></div>
                        <dl>
                            <dt>책임감</dt>
