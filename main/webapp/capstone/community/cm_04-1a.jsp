...
<!DOCTYPE html>
<html lang="en">
<link rel=stylesheet href="cm_04-1a.css">
    ...
    <div class="board_list_wrap">
        <div class="board_list">
            ...
            <div class="middle">
                ...
                <div class="title"><a href="cm_04-2.jsp?bbsID=<%=list.get(i).getBbsID()%>&bbsCategory=<%=list.get(i).getBbsCategory()%>&bbsNum=<%=list.get(i).getBbsNum()%>"><%=list.get(i).getBbsTitle() %></a></div>
        ...
        <div class="sign_up">
            <a href="cm_04-3.jsp" style="color: white;">글쓰기</a>
        </div>
        <div class="board_page">
        	<%
                if(pageNumber != 1) {
            %>
                <a href="cm_04-1a.jsp?pageNumber=<%=pageNumber - 1 %>" class="num on">1</a>
            <%
                } 
        		if (bbsDAO.nextPage(pageNumber + 1, bbsCategory)) {
            %>
                <a href="cm_04-1a.jsp?pageNumber=<%=pageNumber + 1 %>" class="num">2</a>
            <%
                }
        		if (pageNumber == 1) {
        	%>
        			<a href="cm_04-1a.jsp" class="num on">1</a>
        	<%
        		}
        	%>
