...
<div class="wrap">
    ...
    <% } %>       
    <%if (bbsCategory.equalsIgnoreCase("Q")) { %>
        <div class="bg1 bg1_deep">
            <div class="title">
                <h5>Q&A</h5>
            </div>
    ...
    <% } %>  
    <%if (bbsCategory.equalsIgnoreCase("FREE")) { %>
        <div class="bg1 bg1_deep">
            <div class="title">
                <h5>자유게시판</h5>
            </div>
    ...
    <% } %>  
    <%if (bbsCategory.equalsIgnoreCase("LATTER")) { %>
        <div class="bg1 bg1_deep">
            <div class="title">
                <h5>후기</h5>
            </div>
        ...
        <div class="sub_tab">
            <div class="sub_tab_co">
                <div class="sub_tab_in">
                    ...
                    --><a href="cm_03-1a.jsp" class="bactive">Q&A</a><!--
                    --><a href="cm_04-1a.jsp" class="bactive">자유게시판</a><!--
                    --><a href="cm_05-1a.jsp" class="active">후기</a>
                </div>
            </div>
        </div> 
    <% } %>  
    ...
    <div class="outer">
        <div class="write_wrap">
            <div class="notice_area">
                ...
                <div>
                    <form action="updateAction.jsp?bbsID=<%= bbsID %>&bbsCategory=<%= bbs.getBbsCategory() %> " method="post">
                        <div >
                            <h4>제목</h4>
                            <span class="input_area"> <input type="text" name="bbsTitle" required maxlength="50" value="<%= bbs.getBbsTitle() %>" ></span>
                            <h4>내용</h4>
                            <textarea class="textarea" rows="20" cols="105" name="bbsContent" maxlength="2048" required><%= bbs.getBbsContent() %></textarea>
                        </div>
                        <%if (bbsCategory.equalsIgnoreCase("Q")) {%>
                        <div class="secretB">
                        ...
                        <a href="cm_03-1a.jsp" style="color: white;">목록</a>
                        ...
                        <a href="cm_05-1a.jsp" style="color: white;">목록</a>
                        <%} %>
                        </div>
                        <div class="make">
