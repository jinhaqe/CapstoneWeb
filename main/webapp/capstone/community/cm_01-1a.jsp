...
<!DOCTYPE html>
<html lang="en">
<link rel=stylesheet href="cm_01-1a.css">
...
<div class="wrap">
    ...
    <div class="board_list_wrap">
        <div class="board_list">
			...
			%>
			<div class="middle">
			    <div class="num"><%= bbs.getBbsID() %></div>
			    <div class="title"><a href="cm_01-2.jsp?bbsID=<%= bbs.getBbsID() %>&bbsCategory=<%= bbs.getBbsCategory() %>"><%= bbs.getBbsTitle() %></a></div>
			    <div class="userID"><%= bbs.getUserID() %></div>
			    <div class="date"><%= (bbs.getBbsDate() != null && bbs.getBbsDate().length() >= 10) ? bbs.getBbsDate().substring(0, 10) : "" %></div>
           ...
           <%
	        ...
	        %>
	            <div class="sign_up">
	                <a href="cm_01-3.jsp" style="color: white;">글쓰기</a>
	            </div>
	        <%
	            }
	        %>
        ...
        <div class="board_page">
        	<%
                if(pageNumber != 1) {
            %>
                <a href="cm_01-1a.jsp?pageNumber=<%=pageNumber - 1 %>" class="num on">1</a>
            <%
                } 
        		if (bbsDAO.nextPage(pageNumber + 1, bbsCategory)) {
            %>
                <a href="bbs.jsp?pageNumber=<%=pageNumber + 1 %>" class="num">2</a>
            <%
                }
        		if (pageNumber == 1) {
        	%>
        			<a href="cm_01-1a.jsp" class="num on">1</a>
        	<%
        		}
        	%>
