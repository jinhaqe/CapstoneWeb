...
<!DOCTYPE html>
<html lang="en">
<link rel=stylesheet href="cm_06-3.css">
...
<body>
    ...
    <div class="box">
        <div class="Login">
            <p>
                <a href="../IntLogImsi/login.jsp"  class="cwhite">로그인 페이지 이동</a><!--로그인 페이지로 이동-->
            </p>
        </div>
        <div class="main">
            <p>
                <a href="../../capstone/cp_intro.jsp">확인</a> <!--메인 페이지로 이동-->
            </p>
        </div>
    </div>
    </div>
