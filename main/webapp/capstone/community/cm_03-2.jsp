...
<!DOCTYPE html>
<html lang="en">
<link rel=stylesheet href="../community/cm_03-2.css">
...
<%
		...
		if (request.getParameter("bbsNum") != null) {
			...
			System.out.print("냐냐" + bbsID);
			bbsNum = Integer.parseInt(request.getParameter("bbsNum"));
			System.out.print("냐냐" + bbsNum);
		...
		if (bbsNum == 0) {
			...
			script.println("location.href = 'cm_03-1a.jsp'");
			script.println("</script>");
		}
            ...
            <div class="board_view">
		        <% if (bbs != null) { %>
		            ...
		            <div class="info">
		                ...
		                <dl>
		                    <dt>작성일</dt>
		                    <input type="hidden" name="bbsCategory" value="Q">
