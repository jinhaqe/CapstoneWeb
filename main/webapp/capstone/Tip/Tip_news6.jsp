        ...
        <div>
            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        <h3 class="nm">
                            ෆ˙ᵕ˙ෆ 다온 ෆ˙ᵕ˙ෆ 사무실 이전 안내
                        </h3>
                        <div class="view_info">
                            <span>2024.03.18 11:15</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                            ...
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:rgb(233, 125, 129); color: white;">♥ 다온의 새 보금자리를 소개합니다 ♥ </span>
                                            <br>
                                            모두의 응원에 힘입어 다온이 쾌적하고 따스한
                                            <br>
                                            환경으로 여러분들께 인사드릴 수 있게 되었습니다!!
                                            <br>
                                            <br>
                                            <br>
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <img src="../icon/news/news606.png">
                                            <br style="clear:both;">
                                            <img src="../icon/news/news6061.png" style="width: 900px;">
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:rgb(233, 125, 129); color: white;">♥ 새로운 다온에서 새롭게 만나요 ♥ </span>
                                            <br>
                                            전체적으로 따뜻하고 부드러운 느낌이 드는 내부 인테리어와
                                            <br>
                                            심플한 공간으로 더 자주 오고 싶은 다온이 되었습니다~ ♥ 
                                            <br>
                                            <br>
                                            <br>
                                            <br>
                                            <img src="../icon/news/news6062.png" style="width: 900px; height: 450px;">
                                        </span>
                                    </p>
