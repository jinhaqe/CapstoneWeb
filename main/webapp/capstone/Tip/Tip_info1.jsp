            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2023.04.05 14:05</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                        <div class="user_contents">
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: red;">
                                            <br style="clear:both;">
                                            "연애를 잘하는 사람들은 애정 운이 좋아서가 아니라 의지적으로 그 길을 갔기 때문이다"
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            그들은 자신의 나태함을 다른 것으로 때우려 한다.
                                            <br>
                                            연애는 의지적으로 추구해야 할 일이며, 행복한 연애의 대상은 딱 하나로 정해져 있지 않다 .
                                            <br>
                                            그것을 전제로 우리는 다음 같은 결론을 도출할 수 있다
                                        </span>
                                        <br>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            ->
                                            <br>
                                            다른 사람이 먼저 다가오는 것을 막연히 기다릴 게 아니라
                                            <br>
                                            나가서 나와 맞는 인연을 만나고 찾아가라.
                                            <br>
                                            언제나 다가와주는 것을 바라게 된다면 나와 잘 맞는 사람을
                                            <br>
                                            만나는 것은 먼 훗날이 아니라 아예 불가능할 수도 있다.
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            ->
                                            <br>
                                            다양한 사람을 만날 수 있는 사회적 환경을 택해 그곳에 있어라.
                                            <br>
                                            물론 연애 대상으로 손색이 없는 사람들이어야 한다.
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            ->
                                            <br>
                                            여러 사람을 만나고 다양한 경험을 쌓아야 한다.
                                            <br>
                                            그러려면 나의 이상형을 찾는 일에 더욱 진지해져야 하고 자신의 성품
                                            <br>
                                            [재정적, 관계적, 정서적 측면] 에 집중해야 한다. 
                                            <br>
                                            성적으로 지름길을 택하면 건강한 연애가 막히고 거룩한 해결책이 지연된다.
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            ->
                                            <br>
                                            최선을 다해 자신을 더욱 매력 있는 연애 대상감으로 가꾸라.
                                            <br>
                                            큰 빚을 지지 마라. 
                                            <br>
                                            몸 상태를 좋게 할 필요가 있다면 그렇게 하라.
                                            <br>
                                            당신 쪽에서 노력하지 않은 채 연애 대상을 기다리는 것은 책임 회피다.
                                            <br>
                                            당신의 인연은 당신이 결점을 고치기를 기다리고 계실지도 모른다.
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            ->
                                            <br>
                                            게으름은 결코 연애를 조화롭게 하지 못한다.
                                            <br>
                                            나태한 사람은 누구나 싫어한다.
                                            <br>
                                            당신이 연애의 진지한 추구를 뒤로 미루고 몸 상태를 좋게 할 필요성을 부인한다면,
                                            <br>
                                            나중에 그 행동의 결과를 거둘 때 다른 사람을 탓하지 마라.
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            ->
                                            <br>
                                            연애을 추구하는 것은 선하고 거룩한 일이지만, 
                                            <br>
                                            그것이 가장 중요한 추구가 되어서는 안된다.
                                            <br>
                                        </span>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            훌륭한 인연을 찾는 일은 복권 당첨이나 신비 체험이 아니다.
                                            <br>
                                            물론 다른 사람의 조언을 구하지 말아야 한다는 말이 아니다.
                                            <br>
                                            당연히 당신은 기도해야 한다.
                                            <br>
                                            하지만 결국 지혜로운 조언에 기초하여 당신이 합리 적인 선택을 내리는 것이다.
                                            <br>
