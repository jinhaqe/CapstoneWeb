...
<head>
    <meta charset="UTF-8">
    <link rel=stylesheet href="Tip1.css">
   	...
   	<script>
        ...
        <div>
            <div class="bg1 bg1_deep">
                <div class="title">
                    <h5>광고 스토리</h5>
                    <p>고객과 함께 소통하며 성장해온 다온의 스토리</p>
                </div>
            </div> 
            <div class="sub_tab">
                <div class="sub_tab_co">
                    <div class="sub_tab_in">
                        <a href="Tip1.jsp" class="active">광고 모음</a><!--
