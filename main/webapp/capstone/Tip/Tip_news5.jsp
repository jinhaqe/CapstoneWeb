            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2023.02.22 10:37</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <img src="../icon/news/news11.png" style="width: 900px; height: 1100px;">
                                            <br style="clear:both;">
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <br>
                                            <span style="font-size : 20px; color:rgb(239, 0, 124)">[로맨틱 리뷰 이벤트]</span>
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">1등_진공 무선청소기 (1명)</span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">2등_갤럭시 버즈2 (1명)</span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">3등_무선충전 탁상시계 (3명)</span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">4등_공기정화식물 디퓨저 (8명)</span>
                                            <br>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">★☆★☆★☆★☆</span>
                                            <br>
