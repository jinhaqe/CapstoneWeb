            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2023.05.22 11:09</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <img src="../icon/love/love_17.jpg">
                                            <br style="clear:both;">
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: palevioletred;">
                                            <br style="clear:both;">
                                            < 사랑은 감정이다? >
                                        </span>
                                        <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            어떤 사람은 사랑을 순전히 감정적인 요소라고 생각합니다.
                                            <br>
                                            연애와 사랑을 두고 “다이내믹한 감정의 파도”라고 말하는 사람도 있습니다.
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <b style=" text-decoration: underline;">이성을 향해 끌리는 무언가가 나의 감정 상태로 나타나야 사랑이 싹튼다고 생각하는 것이지요.</b>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: palevioletred;">
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            이런 사람은 자기만 그렇게 생각하는 것이 아니라 상대방도 그렇다고 생각합니다.
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: palevioletred;">
                                            ...
                                            <br>
                                            사랑한다는 모든 기준이 서로의 감정 상태에 있다고 믿는 것입니다.
                                            <br>
                                        </span>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            감정 상태를 사랑으로 믿는 사람은 평소에 어떻게 연애를 할까요?
                                            <br>
                                            <b style=" text-decoration: underline;">나와 그(녀)를 어떻게 해서든지 감동시키고 흥분된 감정 상태를 유지하는 데 에너지를 쏟을 것입니다.</b>
                                            <br>
                                            사랑한다는 ‘감정’이 들게 하려고 자기 자신과 그(녀)의 일상에 끊임없는 이벤트를 추구합니다.
                                            <br>
                                            그러다가 어느 날 서로를 향한 감정 상태가 줄어들면 스스로 당황하게 됩니다.
                                            <br>
                                            왜냐하면 그(녀)를 사랑하는 마음이 확 줄었거나 심지어 더 이상 사랑하지 않는다고 생각하기 때문입니다.
                                            <br>
                                            반대의 경우도 마찬가지입니다.
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: rgb(81, 143, 187);">
                                            그(녀)가 나를 사랑하고 있다는 감정이 느껴지지 않으면, 
                                            <br>
                                            그 사람 역시 나를 더 이상 사랑하지 않는다고 생각해 버립니다.
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            그렇다면 사랑하는 데 있어 감정 상태가 전혀 중요하지 않을까요? 절대 그렇지 않습니다.
                                            <br>
                                            서로가 열렬한 사랑에 빠지면 당연히 흥분되는 감정으로 충만해집니다.
                                            <br>
                                            하지만 정확하게 알아야 합니다.
                                            <br>
                                            이때 생겨나는 사랑의 ‘감정’은 동일한 상태로 계속해서 지속될 수는 없습니다.
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: rgb(81, 143, 187);">
                                            사랑한다는 감정 상태가 충만하다가도 시간이 지날수록 그 상태가 소멸되는 시점이 옵니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <b style=" text-decoration: underline;">다시 말해, 사랑의 감정은 가변적입니다!</b>
                                            <br>
                                            생물학자들은 사랑의 감정을 호르몬 분비로 설명합니다.
                                            <br>
                                            남녀가 사랑에 빠지면 뇌가 극도로 활성화되어 여러 가지 호르몬을 분비하게 됩니다.
                                            <br>
                                            일반적으로 도파민, 페닐에틸아민, 옥시토신, 엔도르핀이 사랑에 관여하는 호르몬입니다.
                                            <br>
                                            그래서 이 4가지를 ‘사랑 호르몬’이라고 부릅니다.
                                            <br>
                                            이 중에서 옥시토신은 더 자주 ‘사랑 호르몬’이라 불리는데, 
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: palevioletred;">
                                            이러한 호르몬 분비가 연애 중에 사랑의 ‘감정’을 결정하고 있습니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            그런데 문제는 호르몬 분비 상태가 계속 절정을 유지할 수는 없다는 것이지요.
                                            <br>
                                            연구자들마다 조금씩 차이가 있지만, 통상적으로 6개월이 지나면 호르몬 분비가 급격히 줄어든다고 합니다.
                                            <br>
                                            흥미롭게도 사랑에 빠진 커플들의 뇌를 분석해서 같은 결과를 도출한 실제 실험이 있습니다.
                                            <br>
                                            <b style=" text-decoration: underline;">보통 18-30개월 정도 지나면, 같은 대상에게는 호르몬의 영향력이 거의 소멸됩니다.</b>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: rgb(81, 143, 187);">
                                            바로 이때부터 서로의 눈을 멀게 한 ‘콩깍지’가 벗겨지는 것입니다.
                                            <br>
                                            <br>
                                            <br>
                                            종합해 보면, 많은 경우에 연인들은 서로 사랑한다는 기준을 호르몬 분비에 따른 감정 상태에 두고 있습니다.
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            젊은 혈기에 열정적인 사랑의 ‘감정’을 느끼고 싶은 건 당연하겠지만, 
                                            <br>
                                            종합해 보면, 많은 경우에 연인들은 서로 사랑한다는 기준을 호르몬 분비에 따른 감정 상태에 두고 있습니다.
                                            <br>
                                            <b style=" text-decoration: underline;">감정 자체를 사랑으로 믿는 본성(?)에서 벗어나야 합니다.</b>
                                            <br>
                                            그렇지 않으면 사랑하는 대상이 자신의 호르몬 분비에 따라 끊임없이 바뀔 것입니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em; color: palevioletred;">
                                            사랑하는 데 있어 감정이 참으로 중요한 요소이지만, 감정 자체가 사랑이 아님을 반드시 기억해야 합니다.
                                            <br>
                                            <br>
                                            <br>
                                        </span>
