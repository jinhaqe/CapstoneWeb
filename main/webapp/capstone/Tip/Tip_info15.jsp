            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.04.26 15:42</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                            ...
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            그런데 시간이 지나고 점점 서로가 편해지고
                                            <br>
                                            익숙해지다 보면 그때부터 단점들이 보이기 시작한다.
                                            <br>
                                            초반에는 몰랐던 모난 점들이 눈에 밟혀
                                            <br>
                                            종종 다툼이 일어나고 서서히 콩깍지가 벗겨진다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            여기서 알아야 할 것은 콩깍지가 벗겨지고 있는 그대로의 상대방이
                                            <br>
                                            선명히 보이기 시작하는 그 순간부터가<span style="color: rgb(106, 101, 187);">진짜 사랑의 시작이라는 것</span>이다.  
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            그 사람은 변하지 않았다. <b>변한 건 그 사람을 보는 나의 시선일 뿐.</b>  
                                            <br>
                                            상대방의 좋은 모습들이 없어진 것도 아니고 없었던 단점이 생겨난 것도 아니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            하지만 이때 서로의 <span style="color: rgb(106, 101, 187);">단점들은 맞춰 가려 노력하고</span>  
                                            <br>
                                            <span style="color: rgb(106, 101, 187);">상대방의 좋은 모습들을 자주 꺼내 주고 사랑해 준다면!</span>
                                            <br>
                                            <br>
                                            ...
                                            그때부터 관계는 한층 더 돈독해진다. 
                                            <br>
                                            <b>연애 초반의 설렘과 소중함을 그대로 간직하면서</b>
                                            <br>
                                            <b>그때보다 안정적이고 편한 관계로 발전할 수 있게 된다.</b>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            명심하자.<span style="color: palevioletred;">상대방의 가치는 내가 알아봐 줄 때 더욱 빛나는 법이고</span>  
                                            <br>
                                            <span style="color: palevioletred;">나 또한 나의 가치를 상대방이 알아봐 줄 때 내가 더 빛나게 되는 법이다.</span>   
                                            <br>
                                            <br>
                                            장점은 더욱 키워주고 단점은 맞춰가며 서로가 서로의 가치를 더욱 높여주는 것. 그게 진정한 사랑이다.
                                            <br>
                                            <br>
                                            <br>
                                            <br>
