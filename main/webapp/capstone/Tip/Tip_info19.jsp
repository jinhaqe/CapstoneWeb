            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2023.02.21 11:55</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                            ...
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            소개팅에서<span style="color: palevioletred;"> '분위기는 좋았다' </span>라는 말은 자신만의 생각일 가능성이 매우 높습니다.  
                                            <br>
                                            실제로 분위기가 좋아서 내심 기대했는데 이후 연락이 없어서
                                            <br>
                                            고민하는 사람들 중 의외로 많은 비율이
                                            <br>
                                            <span style="color: palevioletred;">혼자 도취되어 신나게 자기 얘기만 하고 온 경우</span>거든요.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            잘 들어주는 상대를 만나면 내 얘기를 다 털어놓아야 직성이 풀려요.
                                            <br>
                                            그리고 너무 재밌었고 분위기가 좋았다고 믿게 되지요.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            상대방 입장에선 예의를 지켜야 한다는 생각에 어지간하면 다 들어주다가 곧 지쳐 버립니다.
                                            <br>
                                            이러한 습관은 고치기 어렵지만조금만 신경 쓰면 어느 정도는 막을 수 있습니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <b style="color: rgb(106, 101, 187);">방법 1. </b><b style="color:palevioletred;">3초 쉬기</b> 
                                            <br>
                                            말하기 전 속으로 3초를 세면 계속 뭔가 말할 것 같은 느낌에 제동을 걸어줍니다.
                                            <br>
                                            이때 속으로 할 말을 압축하면 좋아요. 그냥 3초만 세도 마음에 훨씬 여유가 생깁니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <b style="color: rgb(106, 101, 187);">방법 2. </b><b style="color:palevioletred;">1+1</b> 
                                            <br>
                                            내 이야기를 하나 했으면, 상대에게 한 가지 질문을 합니다.
                                            <br>
                                            상대의 학교나 직업 등에 대해 미리 알아두면 더 적절한 질문을 할 수 있어요.
                                            <br>
                                            이게 어렵다면 내 이야기를 하나 하고 나서 자연스럽게 "그쪽은 어떠세요?" 라고 진심을 담아 물어봐 줍니다.
                                            <br>
                                            <br>
                                            밀란 쿤데라의 소설 <참을 수 없는 존재의 가벼움>에는 이런 말이 존재합니다.
                                            <br>
                                            <br>
                                            <span style="color: rgb(106, 101, 187);">"질문이란 이면에 숨겨져 있는 것을 볼 수 있도록 무대장치의 화폭을 찢는 칼과 같은 것이다."</span>
                                            <br>
                                            <br>
