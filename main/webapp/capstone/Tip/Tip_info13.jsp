            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.05.09 08:38</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            오해하지 말자. 각자의 삶에 대한 계획과 때와 이유를 다 알 수는 없다. 
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color: rgb(106, 101, 187); font-size: 17px;">1. 연애 대상에 관하여 지나친 욕심이 있다.</span>  
                                            <br>
                                            <br>
                                            <span style="color: brown;">• 완벽한 사랑관 : </span>꿈에 그리는 이상형이 있을 거라고 믿는다. 완벽한 이상형을 만나면 연애가 순조롭게 풀릴 거라고 믿는다.
                                            <br>
                                            그래서 특정 조건의 상대를 탐색하기에 바쁘다. 혹은 상대가 내가 원하는 기대대로 움직여 주기를 바란다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color: brown;">• 비현실적인 기대 : </span>그동안 꾸어 온 꿈이 너무 크다. 조금이라도 부합하지 않으면 그 만남을 이어 가지 않는다. 
                                            <br>
                                            내가 원했던 그림과 어그러지는 것 같으면 일단 브레이크를 건다. 행복은 상황이 저절로 맞춰져서라기보다는 내가 '만들어'가는 것이다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <br>
                                            <span style="color: rgb(106, 101, 187); font-size: 17px;">2. 스스로 준비되고 훈련되어야 하는 부분이 있다.</span>  
                                            <br>
                                            <br>
                                            <span style="color: brown;">• 낮은 자존감 : </span>나 스스로를 어떻게 바라보고 있는가? 하나님의 시선이 자존감의 척도가 되어야 한다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color: brown;">• 과거의 상처 : </span>역기능적 가정에서 자랐는가? 과거의 이성들에 대한 기억은 어떤가?
                                            <br>
                                            상처와 트라우마가 있다면 그것에 계속 묶여서 앞으로 나아가는 데 방해가 된다.
                                            <br>
                                            <br>
                                            <span style="color: brown;">• 인간관계의 미숙함 : </span>다음은 철벽녀, 철벽남의 특징이다. 그들은 경직된 바운더리를 지니고 있다. 바운더리를 침해하는 것도 문제지만, 
                                            <br>
                                            바운더리를 두껍게 설정하는 것 또한 관계에 악영향을 끼친다. 내가 해당되는 것이 있는지 점검해 보자.
                                            <br>
                                            <br>
