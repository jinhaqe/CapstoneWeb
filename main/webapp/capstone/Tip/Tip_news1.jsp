        ...
        <div>
            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        <h3 class="nm">
                            봄맞이 봄이왔나봄 리뷰이벤트(기간연장!)
                        </h3>
                        <div class="view_info">
                            <span>2024.05.10 18:02</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <br>
                                            <span style="font-size : 20px; color:rgb(239, 0, 124)">[봄이왔나봄 봄맞이 리뷰 이벤트]</span>
                                            <br>
                                            <span style="font-size : 20px; color:rgb(239, 0, 124)"> ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ </span>
                                            <br>
                                            <br>
                                            <br>
                                            <span style="background-color:green; color: white; font-size: 20px;">5월 17일까지 이벤트 기간 연장!!</span>
                                            <br>
                                            <br>
                                            <br>
                                            2024년, 따뜻한 날씨와 함께
                                            <br>
                                            좋은 순간을 함께할 인연을 찾으실 수 있도록
                                            <br>
                                            다온[ D A O N ]과 함께해주세요^^
                                            <br>
                                        </span>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:rgb(233, 125, 129); color: white;">참여하신 모든 분들께</span>
                                            <br>
                                            <span style="background-color:rgb(233, 125, 129); color: white;">100%!! 경품을 제공드리니</span>
                                            <br>
                                            <span style="background-color:rgb(233, 125, 129); color: white;">놓치지 말고 꼭 참여해주세요^^</span>
                                            <br>
                                            <br>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">★☆★☆★☆★☆</span>
                                            <br>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">1등_롯데모바일교환권 (1명)</span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">2등_기내용 캐리어 20인치 (1명)</span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">3등_무드등 가습기 (2명)</span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">4등_교촌치킨 반반 점보윙 (5명)</span>
                                            <br>
                                            <br>
                                            <span style="color:rgb(233, 125, 129);">★☆★☆★☆★☆</span>
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color:rgb(233, 125, 129); font-size: 15px;">♡♡♡지금 바로 참여해보세요♡♡♡ </span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129); font-size: 15px;">STEP1, 앱 리뷰 작성 후  캡쳐→ </span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129); font-size: 15px;">STEP2, 카카오톡플러스 친.구.추.가 후 </span>
                                            <br>
                                            <span style="color:rgb(233, 125, 129); font-size: 15px;">캡쳐내용과 개인정보를 전송하면 100% 경품 당첨!!!!!!</span>
                                            <br>
                                            <br>
                                            <br>
                                            <span style="color:pink; font-size: 15px;">자세한 이벤트 참여 방법은 아래 내용을 참고 해주세요~!!!</span>
                                            <br>
                                            <br>
                                            <br>
                                            <img src="../icon/news/news101.jpg">
                                            <br style="clear:both;">
                                        </span>
                                    </p>
