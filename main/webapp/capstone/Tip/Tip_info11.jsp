            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.05.22 11:02</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            그렇다면 결혼은 어떻게 시작되는가? 
                                            <br>
                                            물론 대다수 독자는 배우자가 될 사람을 열심히 찾아 나서야 한다고 답할 것이다. 하지만 이는 현대식 답이다. 
                                            <br>
                                            과거에는 집안에서 연인을 정해 주었다. 불과 백 년 전까지만 해도 선택은 본인이 내릴지언정 선택의 폭은 집안에서 정해 주었다. 
                                            <br>
                                            대다수 사람의 생활 반경이 지금보다 좁았으므로 비교적 적은 인원수 중에서 연인을 골라야 했다. 
                                            <br>
                                            또한 어려서부터 쭉 직접 만나 서로 교류하면서 사실상 그들 전부를 평가할 수 있었다.
                                            <br>
                                            <br>
                                            <br>
                                            <b>하지만 지금은 완전히 달라졌다.</b> 데이트 앱에 들어가면 약 3천만 명의 가입자가 당신을 기다리고 있다. 
                                            <br>
                                            연인 후보가 하도 많아 머리가 어찔할 정도이고, 그중에서 고르다 지칠 수도 있다. 
                                            <br>
                                            설령 두려움을 극복한다 해도, 수천 명의 사람을 직접 만나 보지 않고 온라인으로만 만나 평가한다는 방식 자체 때문에 연인을 찾는 일이 쇼핑 경험으로 변질될 수 있다. 
                                            <br>
                                            인성을 알 수 없으니 키와 몸무게와 외모 등으로 비교해야 하고, 그 과정에서 인격체가 소비 상품으로 전락하는 것을 피할 수가 없다.
                                            <br>
                                            <b>문제는 SNS가 없던 시절에도 그런 식으로 행동하는 경향이 우리에게 너무 농후했다는 것이다. </b>
                                            <br>
                                            우선 온라인상에 올라온 교제 대상들은 자신의 모습을 철저히 여과한다는 게 큰 문제다. 
                                            <br>
                                            성격 좋고 잘 통하는 사람을 찾고 싶은데 한 연구자의 지적처럼 그것을 온라인으로 판별할 수 있다는 증거가 없다.
                                            <br>
                                            노스웨스턴대학교의 일라이 핑클에 따르면, 오히려 온라인일수록 오해가 난무한다. 
                                            <br>
                                            <span style="color:brown;">"당신은 어련히 알아서 한다고 생각하지만, 사실은 서로 마주 앉아 음료라도 한잔해 봐야 한다."</span>
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            그렇지는 않다. 다만 반드시 이런 식으로 진행하기를 권한다. 
                                            <br>
                                            <br>
                                            <span style="color:green;">첫째, 연인 될 사람을 "쇼핑하듯" 골라서는 안 된다. 순전히 외모와 재정만 보고 사람을 배제시키지 말라. </span>
                                            <br>
                                            <br>
                                            <span style="color:green;">둘째, "서로 마주 앉아" 이야기 나누며 알아 갈 수 있는 기회를 마련하라.</span>
                                            <br>
                                            <br>
