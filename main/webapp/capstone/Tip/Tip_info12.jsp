            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.05.16 08:56</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            그런데 상대의 나이가 저보다 다섯 살이 많아요. 성격은 진짜 좋다고 해요. 친구가 겪어 봤는데 저랑 정말 잘 어울릴 것 같대요.
                                            <br>
                                            근데 저는 내키지가 않아요. 상대는 신앙생활을 진짜 열심히 잘 하는데 부모님은 교회를 안 다니신다고 하네요. 아참! 그 사람 키도 작대요."
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            소개팅이 들어와도 걸리는 게 너무 많다. 좋은 점보다는<b style="font-size: 12px;">단점이 계속 아쉽다. </b>  
                                            <br>
                                            고독의 시기를 보내고 있다면 사람에 대한 고정관념과 편견이 있는 편은 아닌지 점검해 보았으면 한다. 
                                            <br>
                                            에리히 프롬(Erich Fromm)의 《사랑의 기술》에 다음과 같은 문장이 나온다. 
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            "사랑은 활동이며 영혼의 힘임을 알지 못하기 때문에 사람들은 단지 올바른 대상을 찾아내는 것만이 필요하며,   
                                            <br>
                                            그렇게 되면 그 밖의 일은 모두 저절로 될 것이라고 믿는다. 
                                            <br>
                                            이 태도는 <b> 그림을 그리고 싶어 하면서도 기술은 배우지 않고 올바른 대상만을 고르면서 </b>
                                            <br>
                                            그렇게 되면 그 밖의 일은 모두 저절로 될 것이라고 믿는다. 
                                            <br>
                                            <span style="color: green;">대상만 찾아내면 아름답게 그릴 수 있다고 주장하는 사람의 태도</span>에 비유할 수 있다."
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            그런 사람들은 연애를 위한 구체적인 기술을 연마하는 일을 소홀히 하고 회피한다. 다음과 같은 노력을 기울여야 한다.
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color: skyblue; font-size: 17px;">1. 필드로 나오자.</span>   
                                            <br>
                                            드라마와 영화 속 연애는 실제와 다르다. 관계의 기술은 직접 마주치면서 배우는 수밖에 없다. 
                                            <br>
                                            완벽한 외모의 여성, 각본대로 타이밍 맞게 움직여 주는 남성의 환상에서 벗어나야 한다.
                                            <br>
                                            <b> 필드로 직접 나와 이성을 알아보는 노력을 반드시 해야 한다. </b>
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color: skyblue; font-size: 17px;">2. 최선을 다하자.</span>   
                                            <br>
                                            청년들 중에서 감나무에서 감 떨어지듯 완벽한 사람과의 만남을 기대하는 경우를 심심치 않게 볼 수 있다. 
                                            <br>
                                            믿음이 아니라 미신에 가깝다. 초자연 법칙과 자연 법칙이 있다.
                                            <br>
                                            초자연 법칙은 기도로 가능하지만, 자연 법칙은 우리의 노력으로 채워야 하는 인과 법칙이다. 연애와 결혼도 똑같다. 
                                            <br>
                                            왜 최선을 다하지 않을까? 200% 노력을 쏟아 부었는데, 거기에 미치지 못하는 결과를 받아들이기가 두렵고 좌절스럽기 때문은 아닐까? 
                                            <br>
                                            <b>이 지점을 용기 있게 극복한 사람들만 열매를 맺는다. </b>
                                            <br>
                                            혹시 큰 시험을 앞두고 오답 노트를 만든 적이 있는가? 똑같은 문제가 나왔을 때 틀리지 않기 위한 효과적인 방법이다. 
                                            <br>
                                            그런데 끝까지 노력해 보지 않은 사람은 오답 노트조차 작성할 수 없다. 오답 노트가 없으면 다음 시험에 같은 실수를 반복하게 된다. 
                                            <br>
                                            안타깝지만 점수가 늘 그대로다.
                                            <br>
                                        </span>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;"> 
                                            <br>
                                            <b>소개팅이 들어오면 일단 만나 보자. 그 사람과 성사되지 않아도 뭐라도 배울 수 있을 것이다. 이성과의 접촉을 최대한 늘려 보자. </b>
                                            <br>
                                            <br>
                                            <br>
                                            <br>
