            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.03.20 10:37</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                            ...
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            사랑에 빠진 경험이 일시적으로 고조된 상태라는 것을
                                            <br>
                                            인식하고 연인과 더불어 "진정한 사랑"을 추구하라는 것이다.
                                            <br>
                                            이러한 사랑도 본래 감정적이기는 하나 어떤 것에 사로잡힌 것은 아니다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <b>우리의 가장 기본적인 감정의 욕구는</b>  
                                            <br>
                                            <b>사랑에 빠지는 것이 아니라, 상대방으로부터 본능이 아닌</b>  
                                            <br>
                                            <b>이성과 선택에서 비롯된 사랑을 받는 것이다.</b>  
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <b>나는 내 안에서 사랑받을 만한 무엇인가를 보고</b>  
                                            <br>
                                            <b>나를 사랑하기로 선택하는</b>  
                                            <br>
                                            <b>누군가에 의해 사랑받을 필요가 있다.</b>  
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            이러한 사랑은 노력과 훈련을 필요로 한다. 
                                            <br>
                                            이것은 만일 연인의 사람이 당신의 노력에 의해
                                            <br>
                                            풍성해진다면 당신 또한 정말 서로 사랑하고 있다는 만족감을 느끼며,
                                            <br>
                                            열심히 연인의 유익을 위해 노력하고자 하는 선택이다.
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            이것은 "사랑에 빠진" 행복감을 필요로 하지 않는다.
                                            <br>
                                            사실 진정한 사랑은 "사랑에 빠진"감정을 벗어나면서 비로서 시작된다.
                                            <br>
                                            <br>
                                            <br>
                                        </span>
