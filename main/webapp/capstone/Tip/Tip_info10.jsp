            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.05.01 08:58</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                            ...
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="font-size : 15px; color:rgb(83, 174, 168)">자신의 사랑의 언어를 발견하는 방법</span>
                                            <br>
                                            <br>
                                            <br>
                                            사랑의 언어 5가지: '함께하는 시간', '봉사', '선물', '스킨십', '인정하는 말'
                                            <br>
                                            자신의 주된 사랑의 언어를 발견하도록 도와주는 3가지 접근 방법이 있다.
                                            <br>
                                            <br>
                                            <br>
                                            <span style="background-color:green; color: white;">1. 자신의 행동을 관찰하라</span>
                                            <br>
                                            <br>
                                            <b>당신은 상대방에 대한 사랑과 감사를 주로 어떻게 표현하는가?</b>
                                            <br>
                                            만일 당신이 자주 사람들의 등을 두드리거나 포용한다면 당신의 주된 사랑의 언어는 '스킨십'일 수 있다.
                                            <br>
                                            사람들을 격려하는 말을 자주 한다면 '인정하는 말'이 사랑의 언어이기 쉽다.
                                            <br>
                                            만일 선물을 잘 준다면 당신이 바라는 것은 '선물'일 것이다.
                                            <br>
                                            친구와 함께 점심을 먹거나 산책하기를 즐긴다면 함께하는 시간'이 사랑의 언어일 것이다.
                                            <br>
                                            늘 다른 사람을 도울 방법을 찾는다면 '봉사'가 주된 사랑의 언어일 수 있다. 
                                            <br>
                                            <b>당신이 사용하는 언어는 당신이 받기 원하는 언어일 가능성이 많다.</b>
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">2. 자신이 불평하는 것이 무엇인지 살펴보라</span>
                                            <br>
                                            <br>
                                            <b>인간관계에서 당신이 가장 자주 불평하는 것은 무엇인가?</b>
                                            <br>
                                            만일 사람들이 도와주지 않는다는 불평을 자주 한다면 '봉사'가 당신의 언어일 것이다.
                                            <br>
                                            친구에게 "우리는 함께하는 시간을 별로 갖지 못했어."라고 자주 말한다면 당신은 '함께하는 시간'을 바라고 있다.
                                            <br>
                                            사업차 여행을 다니는 친구에게 여행 가서 아무것도 안 사온 거야? 라고 말한다면 '선물' 받는 것이 주된 사랑의 언어일 것이다.
                                            <br>
                                            "내가 먼저 시도하지 않으면 당신은 아예 나랑 손도 잡을 생각을 하지 않네요."라고 말한다면 '스킨십이 당신의 주된 사랑의 언어일 수 있다.
                                            <br>
                                            "난 제대로 하는 게 하나도 없어."라는 당신의 불평은 '인정하는 말'을 꼭 듣고 싶은 마음을 나타낸다. 
                                            <br>
                                            <b>불평은 다른 사람에게서 가장 받고 싶어하는 것을 드러낸다.</b>
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">3. 자신이 무엇을 가장 자주 부탁하는지 살펴보라</span>
                                            <br>
                                            <br>
                                            여행을 떠나는 친구에게 깜짝 선물 잊지 마."라고 말한다면 이는 당신에게는 '선물'이 중요함을 뜻한다.
                                            <br>
                                            "오늘 저녁에 같이 산책할까?"라는 말은 함께하는 시간'을 갖고 싶다는 뜻이다.
                                            <br>
                                            등을 긁어 달라고 부탁하는 것은 '스킨십'을 원하고 있는 것이다.
                                            <br>
                                            만일 사람들에게 도와달라는 부탁을 자주 한다면 당신의 사랑의 언어는 '봉사'일 가능성이 많은 것이다.
                                            <br>
                                            "나 잘했어요?"라고 묻는 것은 '인정하는 말'을 듣고 싶다는 뜻이다.
                                            <br>
                                            <b>당신이 다른 사람들에 대한 사랑과 감사를 어떻게 표현하는지 살펴보라. </b>
                                            <br>
                                            그리고 자신의 불평과 부탁 사례들을 열거해 보라. 그러면 당신의 주된 사랑의 언어를 찾을 수 있을 것이다.
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color:green;">자신에게 해당하지 않는 사랑의 언어로 말하는 것을 배우려면 노력이 필요하다. </span>
                                            <br>
                                            인정하는 말을 듣지 못하고 자란 사람은 그 말을 하기 어려워한다. 스킨십에 인색한 가정에서 자란 사람은 신체적인 접촉이라는 언어를 사용하는 법을 배워야 한다. 
                                            <br>
                                            다행스럽게도 이 모든 언어들은 습득될 수 있다. 이들을 더 많이 사용할수록 더 쉬워진다.
                                            <br>
                                            데이트 시기에 서로의 주된 사랑의 언어를 배워 두면 그 전환이 훨씬 더 쉬워질 것이다. 
                                            <br>
                                            <br>
                                            <br>
                                            <br>
                                            게리 채프먼, '결혼 전에 꼭 알아야 할 12가지' 중에서 
                                        </span>
                                    </p>
