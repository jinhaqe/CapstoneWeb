            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.06.07 09:31</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                            ...
                            <div alige style>
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">: 우정부터 쌓아라</span>
                                            <br>
                                            나는 소개팅에 나가서 너무 따지지 말라고 조언한다.
                                            <br>
                                            '얘랑 결혼하면 어떨까? 아파트 정도는 마련할 수 있을까?' 이것보다<span style="color:green;"> 같이 있는 시간이 즐거워야 한다. </span> 
                                            <br>
                                            그래서 우정을 먼저 쌓으라고 말한다. 왜냐하면 <span style="color:green;">결혼은 삶의 동반자, 친구를 찾는 것</span>이기 때문이다.
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">: 둘에게만 집중하지 마라</span>
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">: 싸움을 해봐라</span>
                                            <br>
                                            갈등을 해결하는 능력을 서로 테스트해볼 필요가 있다. <b>상대방의 습관도 봐야 한다.</b>
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">: 상대를 위해 자기의 삶을 다 포기하지 마라 </span>
                                            <br>
                                            대학교 때 만난 남자 친구를 위해 유학을 포기한 자매가 있었다. 그 남자 친구는 군대에 다녀와서 자기 인생을 위해 유학을 떠났다. 
                                            <br>
                                            이 일로 자매는 다니던 학교도 나가지 못하게 되었다.
                                            <br>
                                            <b>내 삶의 주인은 나이고, 선택의 책임도 내게 있다. </b>
                                            <br>
                                            남자 친구나 여자 친구 때문에 중대한 결정이 흔들려서는 안 된다. 
                                            <br>
                                            <span style="color:green;">자신의 삶을 책임감 있게 사는 모습이 서로에게 끊임없는 자극과 매력으로 남는다는 것을 기억하라.</span>
                                        </span>
                                        <br>
                                        <br>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="background-color:green; color: white;">:이별 후에 바로 새로운 이성을 사귀지 마라 </span>
                                            <br>
                                            내 연애 패턴은 곧 '내 모습이다. 
                                            <br>
                                            1~2년 만에 한 번씩 나를 찾아오던 여성이 있었다. 실연 후 상실감으로 힘들어하던 그녀는 얼마 지나지 않아 바로 표정이 밝아졌다. 
                                            <br>
                                            아니나 다를까 또 다른 연애를 시작한 것이다. 나는 실연한 커플에게는 적극적으로 '비연애의 자유'를 누리라고 말한다. 
                                            <br>
                                            <b>철저하게 혼자 행복할 수 있는 사람이야말로 연애를 시작할 준비가 된 것이다. </b> 
                                            <br>
