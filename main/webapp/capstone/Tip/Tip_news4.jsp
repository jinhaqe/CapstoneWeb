            ...
            <div class="sub_content">
                <div class="container user_board">
                    <div class="view_top">
                        ...
                        <div class="view_info">
                            <span>2024.04.03 18:02</span> &nbsp;&nbsp; <span>다온 D A O N</span>
                        </div>
                    </div>
                    <div class="view_body">
                                ...
                                <div align style>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <br>
                                            <span style="font-size : 20px; color:rgb(255, 108, 0)">[가을리뷰 선물 대잔치!!]</span>
                                            <br>
                                            <span style="font-size : 20px; color:rgb(255, 108, 0)"> ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ  ෆ˙ᵕ˙ෆ </span>
                                            <br>
                                            <br>
                                            <br>
                                            안녕하세요~! 다온에서
                                            <br>
                                            <span style="font-size : 20px; color:rgb(149, 16, 21)">올 가을을 맞이해서 가을리뷰 선물 대잔치를 준비</span>했습니다.
                                            <br>
                                            <br>
                                            <span style="background-color:rgb(255, 167, 0); color: white;">참여하신 모든 분들께 </span>
                                            <br>
                                            <span style="background-color:rgb(255, 167, 0); color: white; ">100%!! 경품을 제공드리니</span>
                                            <br>
                                            <span style="background-color:rgb(255, 167, 0); color: white; ">놓치지 말고 꼭 참여해주세요^^</span>
                                            <br>
                                            <br>
                                        </span>
                                    </p>
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            <br style="clear:both;">
                                            <span style="color:rgb(149, 16, 21);">★☆★☆★☆★☆</span>
                                            <br>
                                            <br>
                                            <span style="color:rgb(149, 16, 21);">1등_백화점 상품권 20만원권 (1명)</span>
                                            <br>
                                            <span style="color:rgb(149, 16, 21);">2등_마샬 블루투스 스피커 (1명)</span>
                                            <br>
                                            <span style="color:rgb(149, 16, 21);">3등_CGV 영화관람권 2매 (3명)</span>
                                            <br>
                                            <span style="color:rgb(149, 16, 21);">4등_뉴트로지나 핸드크림 (10명)</span>
                                            <br>
                                            <br>
                                            <span style="color:rgb(149, 16, 21);">★☆★☆★☆★☆</span>
                                            <br>
                                    ...
                                    <p>
                                        <span style="font-size: 10pt; letter-spacing: -0.07em;">
                                            ...
                                            <br>
                                            <span style="color:rgb(149, 16, 21); font-size: 15px;">STEP1, 앱 리뷰 작성 후  캡쳐→ </span>
                                            <br>
                                            <span style="color:rgb(149, 16, 21); font-size: 15px;">STEP2, 카카오톡플러스 친.구.추.가 후 </span>
                                            <br>
                                            <span style="color:rgb(149, 16, 21); font-size: 15px;">캡쳐내용과 개인정보를 전송하면 100% 경품 당첨!!!!!!</span>
                                            <br>
                                            <br>
                                            <br>
