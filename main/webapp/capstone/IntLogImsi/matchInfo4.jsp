...
<head>
    ...
    <link rel=stylesheet href="matchInfo4.css?after">
</head>
<body>
    <%
		String userID = null;
    ...
    <header>
   	...
   	<script>
        ...
        <div class="big1">
            <div id="gage">
                    <p id="pageText">STEP 4. 프로필 공개 여부</p>
            ...
            <form method="post" action="matchInfoAction4.jsp">
            <div class="big3">
                <div id="q1">
                    <hr id="hr1">
                    <p id="first">회원님의 프로필이 메인화면에 추천 되길 희망하시나요?</p>
                    <p id="second">*메인화면과 포토 인터뷰 창 내에 몇 가지 정보가 공개되며,</p>
                    <p id="second">매칭을 완료한 상대방에겐 모든 프로필이 공개됩니다.*</p>
                    <div class="input_in">
                        <input type="radio" name="ps_sign" value="yes" id="yeno"><label for="yes" id="text1">네, 희망합니다</label>
                        <input type="radio" name="ps_sign" value="no" id="yeno"><label for="no" id="text1">아니요, 매니저와 매칭 완료 상대에게만 공개 희망합니다</label>
                    </div>
                </div>
            </div>
            <div class="nextBack">
                <button class="before-btn" onclick="location.href='matchInfo3.jsp'">&#10094; 이전</button>
                <input type="submit" class="next-btn" value="프로필 제출하기">
            </div>
            </form>
        </div>
    </div>
