...
<head>
    ...
    <link rel=stylesheet href="matchInfoEnd.css">
</head>
<body>
    <%
		String userID = null;
    ...
    <header>
   	...
   	<script>
        ...
        <div class="big1">
            <div class="big4">
                <div id="bigText">
                    <p id="fu">프로필 작성이 완료됐습니다!</p>
                </div>
                <div id="doing">
                    <p id="sol">나만의 연인을 만나기 위한 프로필 작성에 참여하시느라 고생하셨습니다.</p>
                    <p id="sol">프로필 작성을 완료하신 후에는 상대방과 매칭이 가능합니다.</p>
                    <br>
                    <p id="bol">회원님의 프로필은 다른 회원에게는 다 공개되지 않지만</p>
                    <p id="bol">매칭 완료된 상대방과는 서로 열람 가능하게 됩니다.</p>
                </div>
            </div>
            <div class="nextBack">
                <button class="before-btn" onclick="location.href='../cp_intro.jsp'">홈으로 가기</button>
                <button class="next-btn" onclick="location.href='myPage.jsp'">마이 페이지 가기</button>
            </div>
        </div>
    </div>
</body>
