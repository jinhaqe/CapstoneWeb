...
<head>
    ...
    <link rel=stylesheet href="matchInfo.css?after">
</head>
<body>
    <%
		String userID = null;
    ...
    <header>
   	...
   	<script>
        ...
        <div class="big1">
            ...
            <form method="post" action="matchInfoAction.jsp" enctype="multipart/form-data" accept-charset="UTF-8">
            <div class="big2">
                <div class="imgBox">
                    <div id="image-container">
                        <img id="uploaded-image" alt="필수사진*">
                    </div>
                    <div class="file-upload">
                        <div class="file-name-display" id="file-name">첨부파일</div>
                        <input type="file" name="p_picture" id="file-input" accept="image/*">
                        <label for="file-input" id="label">파일찾기</label>
                    </div>
                </div>
            </div>
            <div class="nextBack">
